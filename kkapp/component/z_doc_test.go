...
func TestDoc_DeploymentLayoutTransparency(t *testing.T) {
	...
	nodesA := []*Application{
		...
		NewApplication(kkapp.NewNodeInfo("n2", "t", "127.0.0.1:9002", ""), af, kkapp.ApplyOptions()),
		NewApplication(kkapp.NewNodeInfo("n3", "t", "127.0.0.1:9003", ""), af, kkapp.ApplyOptions()),
	}
	...
	node1B := NewApplication(kkapp.NewNodeInfo("n1", "t", "127.0.0.1:9001", ""), af, kkapp.ApplyOptions())
	node2B := NewApplication(kkapp.NewNodeInfo("n2", "t", "127.0.0.1:9002", ""), af, kkapp.ApplyOptions())
