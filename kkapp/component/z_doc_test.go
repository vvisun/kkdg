...
func TestDoc_MultipleNodesInOneProcess(t *testing.T) {
	node1 := NewApplication(kkapp.NewNodeInfo("node1", "gate", "127.0.0.1:8080", ""), nil, kkapp.ApplyOptions())
	node2 := NewApplication(kkapp.NewNodeInfo("node2", "game", "127.0.0.1:8081", ""), nil, kkapp.ApplyOptions())
...
func TestDoc_DeploymentLayoutTransparency(t *testing.T) {
	...
	nodesA := []*Application{
		NewApplication(kkapp.NewNodeInfo("n1", "t", "127.0.0.1:9001", ""), nil, kkapp.ApplyOptions()),
		NewApplication(kkapp.NewNodeInfo("n2", "t", "127.0.0.1:9002", ""), nil, kkapp.ApplyOptions()),
		NewApplication(kkapp.NewNodeInfo("n3", "t", "127.0.0.1:9003", ""), nil, kkapp.ApplyOptions()),
	}
	...
	node1B := NewApplication(kkapp.NewNodeInfo("n1", "t", "127.0.0.1:9001", ""), nil, kkapp.ApplyOptions())
	node2B := NewApplication(kkapp.NewNodeInfo("n2", "t", "127.0.0.1:9002", ""), nil, kkapp.ApplyOptions())
