...
func FinishInt32Buffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedInt32Buffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
