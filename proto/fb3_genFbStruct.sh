...
[ -f proto/pbgate/gate.fbs ] && go run ./tools/cmd/fbs2struct -o ./proto/pbgate/fbtgate -pkg fbtgate -flatc-import github.com/vvisun/kkdg/proto/pbgate/fbgate ./proto/pbgate/gate.fbs
